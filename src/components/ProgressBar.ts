...
import { BaseSignal, computed, Signal, signal } from "@tui/signals";
import { Style, StyleBlock, VerticalBlock } from "@tui/nice";
...
export function createProgressBar(styles: Record<"text" | "filled", Style>) {
...
export const ProgressBar = createProgressBar({ text, filled });
