...
import { Block, calc, HorizontalBlock, Style, StyleBlock, VerticalBlock, VerticalBlockOptions } from "@tui/nice";
import {
    computed,
    effect,
    getIntermediate,
...
export function createScrollView(scrollbarStyle: Style) {
...
export const ScrollView = createScrollView(scrollbar);
