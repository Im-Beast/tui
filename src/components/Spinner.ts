...
import { computed, Signal, signal } from "@tui/signals";
import { HorizontalBlock, Style, StyleBlock } from "@tui/nice";
...
export function createSpinner(styles: Record<"text" | "spinner", Style>) {
...
export const Spinner = createSpinner({ text, spinner });
